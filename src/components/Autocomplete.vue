            ...
            <slot name="results">
                ...
                <template v-if="!hasError">
                    ...
                    <li
                            ...
                            v-html="formatListDisplay(result)">
                    </li>
...
<script type="text/babel">
    ...
    export default {
      props: {
        ...
        /**
         * Results property used as the list display
         */
        resultsListDisplay: {
          type: [String, Function],
          default: 'name'
      ...
      methods: {
        ...
        formatListDisplay (obj) {
          switch (typeof this.resultsListDisplay) {
            case 'function':
              return this.resultsListDisplay(obj)
            case 'string':
              if (!obj[this.resultsListDisplay]) {
                throw new Error(`"${this.resultsListDisplay}" property expected on result but is not defined.`)
              }
